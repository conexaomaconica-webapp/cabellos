    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
          <span className="text-xs text-slate-400 uppercase font-bold">Plano SaaS Ativo</span>
          <p className="text-lg font-bold text-purple-300">{subscription?.saas_plans?.name || 'Plano Legado'}</p>
          <span className="text-xs text-slate-400">R$ {subscription?.price_snapshot || 0}/mês</span>
        </div>

        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
          <span className="text-xs text-slate-400 uppercase font-bold">Usuários Vinculados</span>
          <p className="text-lg font-bold text-white">{users.length}</p>
          <span className="text-xs text-slate-400">Admins, Recepcionistas e Profissionais</span>
        </div>

        <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 space-y-1">
          <span className="text-xs text-slate-400 uppercase font-bold">Backups de Segurança</span>
          <p className="text-lg font-bold text-emerald-400">{backups.length} exportações</p>
          <span className="text-xs text-slate-400">Storage Privado</span>
        </div>
      </div>
      ...
      <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 space-y-4">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-slate-300">
            <thead className="bg-slate-950 font-bold text-slate-400 uppercase border-b border-slate-800">
              <tr>
