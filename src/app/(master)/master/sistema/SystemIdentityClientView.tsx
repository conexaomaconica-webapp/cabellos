        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <form onSubmit={handleUpload} className="space-y-4 text-xs">
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Tipo de Ativo</label>
                <select
                  value={uploadType}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Selecionar Arquivo (Max 2MB)</label>
                <input
                  type="file"
                  required
                  accept={
                  ...
                  className="w-full text-slate-700 dark:text-slate-300 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-purple-950/60 file:text-purple-300 hover:file:bg-purple-900 cursor-pointer"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-slate-900 dark:text-white font-bold transition-all disabled:opacity-50"
              >
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <div className="space-y-4 text-xs">
              <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[11px]">Logo Principal</span>
                    <div className="mt-2 p-2 bg-white dark:bg-slate-900/50 rounded-lg inline-block">
                      <BrandLogo 
                        type="primary" 
                ...
                {initialBranding?.logo_primary && (
                  <div className="flex items-center gap-4 pt-3 border-t border-slate-200 dark:border-slate-800/60">
                    <div className="flex-1 space-y-2">
                      <div className="flex justify-between">
                        <label className="text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase">Ajustar Tamanho (Altura)</label>
                    ...
                    <button 
                      ...
                      className="px-4 py-2 rounded-lg bg-purple-600 hover:bg-purple-500 text-slate-900 dark:text-white font-bold transition-all disabled:opacity-50"
                    >
                      Salvar Tamanho
                    </button>
                  </div>
              ...
              <div className="p-4 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <div>
                    <span className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[11px]">Logo Compacta</span>
                    <div className="mt-2 p-2 bg-white dark:bg-slate-900/50 rounded-lg inline-block">
                      <BrandLogo 
                        type="compact" 
      ...
      {activeTab === 'splash' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            <form onSubmit={handleUpload} className="space-y-4 text-xs">
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Formato de Mídia</label>
                <select
                  value={uploadType}
                  onChange={(e) => setUploadType(e.target.value as AssetType)}
                  className="w-full px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white focus:border-purple-500 outline-none"
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Selecionar Mídia (Max 10MB)</label>
                <input
                  type="file"
                  required
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
            ...
            {initialBranding?.splash ? (
              ...
              <div className="p-8 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-center text-slate-500 text-xs">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
              ...
              <div className="p-4 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center gap-3">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-4">
              ...
              <div className="p-4 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl flex items-center justify-between">
              ...
              <tbody className="divide-y divide-slate-800/60">
                {initialAssets.map((asset) => (
                  <tr key={asset.id} className="hover:bg-slate-800/40 transition-colors text-xs">
                    ...
                    <td className="px-6 py-4 text-slate-700 dark:text-slate-300">{asset.file_name || asset.storage_path}</td>
                    <td className="px-6 py-4">
                      {asset.is_active && !asset.archived_at ? (
                        ...
                        <span className="px-2.5 py-0.5 rounded-full font-medium bg-slate-50 dark:bg-slate-800 text-slate-500">
                          ARQUIVADO
                        </span>
                      ) : (
                        <span className="px-2.5 py-0.5 rounded-full font-medium bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400">
                          INATIVO
                        </span>
                      )}
                    </td>
                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      {!asset.is_active && !asset.archived_at && (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-purple-600 hover:bg-purple-500 text-slate-900 dark:text-white font-bold"
                        >
                          Ativar
                        </button>
                      )}
                      {!asset.is_active && !asset.archived_at && (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-slate-50 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold"
                        >
                          Arquivar
                        </button>
                      )}
