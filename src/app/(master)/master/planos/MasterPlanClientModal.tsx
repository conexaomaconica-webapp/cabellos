          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg p-6 space-y-4 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Nome do Plano *</label>
                  <input
                    type="text"
                    required
                    value={formData.name}
                ...
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Slug *</label>
                  <input
                    type="text"
                    required
                    value={formData.slug}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Preço Mensal (R$)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Preço Anual (R$)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Dias Trial</label>
                  <input
                    type="number"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Max Usuários</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Max Profissionais</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block font-bold text-slate-300 uppercase mb-1">Max Clientes</label>
                  <input
                    type="number"
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-4 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-medium disabled:opacity-50"
                >
