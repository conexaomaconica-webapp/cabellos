      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Link href="/cadastros/categorias">
            <Button variant="secondary" className="bg-slate-800 text-slate-200 hover:bg-slate-700 border border-slate-700">
              <FolderKanban className="h-4 w-4 mr-1.5" /> Categorias
            </Button>
          </Link>
          <Link href="/cadastros/servicos/novo">
            <Button variant="default" className="bg-purple-600 text-white hover:bg-purple-500 font-semibold shadow-lg">
                ...
                <div className="space-y-2 text-xs text-slate-300 bg-slate-950/50 p-3 rounded-xl border border-slate-800/80">
                  ...
                  <div className="flex items-center justify-between pt-1 border-t border-slate-800/60">
                    <span className="flex items-center gap-1.5 text-slate-400">
                      <Clock className="h-3.5 w-3.5 text-slate-400" /> Duração Estimada
                    </span>
                    <span className="text-slate-200 font-medium">{service.duration_minutes} min</span>
                  </div>
